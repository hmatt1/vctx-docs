...
<Card title="Easy Simulations" icon="seti:clock">
...
[Get up and running](https://www.google.com/search?q=/vctx-docs/getting-started) with the language and the CLI.
</Card>
<Card title="Learn the Philosophy" icon="open-book">
Understand [why vctx exists](https://www.google.com/search?q=/vctx-docs/language-philosophy) and how it differs from Verilog.
</Card>
</CardGrid>
