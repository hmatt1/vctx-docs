...
The compiler natively tracks bit widths. Operations like `u8 + u8` automatically expand to `u9` to prevent implicit truncation. Narrowing a width requires an explicit `as` cast.
</Card>
